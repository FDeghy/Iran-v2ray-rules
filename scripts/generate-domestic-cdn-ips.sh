...
gh api https://api.github.com/repos/Chocolate4U/Iran-v2ray-rules/contents/text/iranserver.txt?ref=release -H "Accept: application/vnd.github.raw" > ir-cdn/iranserver.txt
